    ...
    <div className="container">
      <div className="row text-center text-xs-center text-sm-left text-md-left">
        ...
        <div className="col-xs-12 col-sm-4 col-md-4">
          <h5>Categories</h5>
          <ul className="list-unstyled quick-links">
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Javascript</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Angularjs</a>
            </li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Reactjs</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Nodejs</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Tutorial</a></li>
          </ul>
        </div>
        <div className="col-xs-12 col-sm-4 col-md-4">
